...
from model_headless import VGG_19_headless_5, VGG_19_headless_4
...
K.set_image_dim_ordering('tf')
copySeqWeights(VGG_19_headless_4(input_shape=(256, 256, 3)), 
    dir + '/vgg-19_weights.hdf5', 
    dir + '/vgg-19-' + K.image_dim_ordering() + '-' + K._BACKEND + '_headless_4_weights.hdf5'
)

K.set_image_dim_ordering('th')
copySeqWeights(VGG_19_headless_4(input_shape=(3, 256, 256)), 
    dir + '/vgg-19_weights.hdf5', 
    dir + '/vgg-19-' + K.image_dim_ordering() + '-' + K._BACKEND + '_headless_4_weights.hdf5'
)
