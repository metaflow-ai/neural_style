...
for idx_content, lc_name in enumerate(layers_names):
    for idx_style, ls_name in enumerate(layers_names):
        ...
        ls = loss_style / layer_weights[ls_name]['style']
        ...
        fullOutPath = resultsDir + '/' + prefix + '_style' + ls_name + '_content' + lc_name + ".png"
        # dump_as_hdf5(resultsDir + '/' + prefix + '_style' + ls_name + '_content' + lc_name + ".hdf5", best_input_data[0])
