...
# data = load_hdf5_im(dir + '/models/results/vgg19/0001_style_conv_1_1_gamma0.001.hdf5')
...
for layer_name in layers_names:
    ...
    for gamma in [1e-03, 0]:
        ...
        grams_style = grams(y_style).copy()
        loss_style = frobenius_error(grams_style, grams(out).copy())
        ...
        best_input_style_data, style_losses = train_input(input_data, iterate_style, adam, config, max_iter=600)
