...
def VGG_16_headless_5(weights_path=None, input_shape=(3, 256, 256), trainable=False, poolingType='max'):
    ...
    if poolingType == 'average':
        p3 = AveragePooling2D((2, 2), strides=(2, 2))(c33)
    else:
        p3 = MaxPooling2D((2, 2), strides=(2, 2))(c33)
    ...
    if poolingType == 'average':
        p4 = AveragePooling2D((2, 2), strides=(2, 2))(c43)
    else:
        p4 = MaxPooling2D((2, 2), strides=(2, 2))(c43)
